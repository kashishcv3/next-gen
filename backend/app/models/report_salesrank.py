"""Auto-generated SQLAlchemy model for `report_salesrank`.

Mirrors the colorcommerce.report_salesrank table. Edit with care — re-running the
...
class ReportSalesrank(Base):
    __tablename__ = "report_salesrank"
    ...
    not_purchased = Column("not_purchased", String(1), nullable=True)
