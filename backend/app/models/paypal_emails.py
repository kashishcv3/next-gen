"""Auto-generated SQLAlchemy model for `paypal_emails`.

Mirrors the colorcommerce.paypal_emails table. Edit with care — re-running the
...
class PaypalEmails(Base):
    __tablename__ = "paypal_emails"
