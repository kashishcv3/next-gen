"""Auto-generated SQLAlchemy model for `category_export`.

Mirrors the colorcommerce.category_export table. Edit with care — re-running the
...
class CategoryExport(Base):
    __tablename__ = "category_export"
