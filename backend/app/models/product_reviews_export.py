"""Auto-generated SQLAlchemy model for `product_reviews_export`.

Mirrors the colorcommerce.product_reviews_export table. Edit with care — re-running the
...
class ProductReviewsExport(Base):
    __tablename__ = "product_reviews_export"
