...
export default function WholesaleShippingPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/wholesale/shipping'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Wholesale Shipping</h1><p><i className="fa fa-truck"></i> Manage wholesale shipments and logistics</p></div></div>
