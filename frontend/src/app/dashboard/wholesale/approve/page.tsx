...
export default function ApproveWholesalersPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/wholesale/approve'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Approve Wholesalers</h1><p><i className="fa fa-check"></i> Review and approve wholesale customer applications</p></div></div>
