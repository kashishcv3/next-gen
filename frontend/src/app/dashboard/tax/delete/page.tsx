...
export default function TaxDeletePage() {
  ...
  const fetchTable = async () => {
    try {
      const res = await api.get(`/tax/tables/${tableId}`);
        ...
        <div className="col-lg-6">
          <div className="panel panel-danger">
            ...
            <div className="panel-body">
              <p>Are you sure you want to delete the tax table "{tableName}"?</p>
              <div className="alert alert-danger">This action cannot be undone.</div>
            </div>
          </div>

          <button className="btn btn-danger" onClick={handleDelete} disabled={loading}>
            {loading ? 'Deleting...' : 'Delete Tax Table'}
          </button>
