...
export default function CustomTaxRatesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Custom Tax Rates saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>Custom Tax Rates</h1>
        <p><i className="fa fa-calculator"></i> Define custom tax rates for your products and regions</p>
      </div></div>
