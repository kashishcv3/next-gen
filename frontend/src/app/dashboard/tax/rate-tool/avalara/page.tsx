...
export default function AvalaraIntegrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/tax/rate-tool/avalara', options);
      setSuccess('Avalara Tax Integration saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>Avalara Tax Integration</h1>
        <p><i className="fa fa-calculator"></i> Configure Avalara tax calculation integration</p>
      </div></div>
