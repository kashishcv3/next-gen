...
export default function ArrowEyePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/orders/gift-card-service/arroweye', options);
      setSuccess('ArrowEye saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>ArrowEye</h1>
        <p><i className="fa fa-eye"></i> Configure ArrowEye gift card service</p>
      </div></div>
