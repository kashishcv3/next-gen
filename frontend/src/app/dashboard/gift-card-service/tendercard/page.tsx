...
export default function TenderCardPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/orders/gift-card-service/tendercard', options);
      setSuccess('TenderCard saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>TenderCard</h1>
        <p><i className="fa fa-credit-card"></i> Configure TenderCard gift card service</p>
      </div></div>
