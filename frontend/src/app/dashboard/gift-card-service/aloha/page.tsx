...
export default function AlohaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/orders/gift-card-service/aloha', options);
      setSuccess('Aloha saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>Aloha</h1>
        <p><i className="fa fa-star"></i> Configure Aloha gift card service</p>
      </div></div>
