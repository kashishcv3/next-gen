...
export default function ValutecPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/orders/gift-card-service/valutec', options);
      setSuccess('Valutec saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>Valutec</h1>
        <p><i className="fa fa-gift"></i> Configure Valutec gift card service</p>
      </div></div>
