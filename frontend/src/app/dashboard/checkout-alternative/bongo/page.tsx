...
export default function FedExCrossBorderOptionsPage() {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>FedEx Cross Border Options</h1>
        <p><i className="fa fa-globe"></i> Configure FedEx Cross Border checkout settings</p>
      </div></div>
