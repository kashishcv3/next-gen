...
export default function OptimizationOptionsPage() {
  ...
  const fetchOptions = async () => {
    try {
      const res = await api.get('/store/display-options/optimization');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/store/display-options/optimization', options);
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1><i className="fa fa-rocket"></i> Optimization Options</h1>
        <p><i className="fa fa-info-circle"></i> Configure performance and optimization settings</p>
      </div></div>
