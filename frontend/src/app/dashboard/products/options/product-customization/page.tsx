...
export default function ProductCustomizationOptionsPage() {
  ...
  const fetchOptions = async () => {
    try {
      const res = await api.get('/products/options/customization');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/products/options/customization', options);
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1><i className="fa fa-sliders"></i> Product Customization Options</h1>
        <p><i className="fa fa-info-circle"></i> Configure product customization features</p>
      </div></div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="row"><div className="col-lg-8">
          <div className="well well-cv3-table">
            <p className="text-muted">Options will be loaded from the API when the backend endpoint is connected.</p>
