...
export default function CustomProductFormsPage() {
  ...
  const fetchItems = async () => {
    try {
      const res = await api.get('/products/customizations');
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1><i className="fa fa-puzzle-piece"></i> Custom Product Forms</h1>
        <p><i className="fa fa-info-circle"></i> Manage custom product forms and customization options</p>
      </div></div>
