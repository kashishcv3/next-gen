...
export default function SearchReviewsPage() {
  ...
  const fetchItems = async () => {
    try {
      const res = await api.get('/products/reviews/search');
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1><i className="fa fa-search"></i> Search Reviews</h1>
        <p><i className="fa fa-info-circle"></i> Search and view product reviews</p>
      </div></div>
