...
export default function SearchQandAPage() {
  ...
  const fetchItems = async () => {
    try {
      const res = await api.get('/products/qanda/search');
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1><i className="fa fa-search"></i> Search Q&A</h1>
        <p><i className="fa fa-info-circle"></i> Search and view product Q&A content</p>
      </div></div>
