...
export default function SearchRecipeReviewsPage() {
  ...
  const fetchItems = async () => {
    try {
      const res = await api.get('/recipes/reviews/search');
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1><i className="fa fa-search"></i> Search Recipe Reviews</h1>
        <p><i className="fa fa-info-circle"></i> Search and view recipe reviews</p>
      </div></div>
