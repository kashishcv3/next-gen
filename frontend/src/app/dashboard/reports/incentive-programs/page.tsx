...
export default function IncentiveProgramsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/reports/incentive-programs'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Incentive Programs</h1><p><i className="fa fa-gift"></i> View and analyze all active incentive programs and rewards</p></div></div>
