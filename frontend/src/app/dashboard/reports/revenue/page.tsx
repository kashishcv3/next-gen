...
export default function RevenuePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/reports/revenue'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Revenue Report</h1><p><i className="fa fa-dollar"></i> Comprehensive revenue analysis and financial metrics</p></div></div>
