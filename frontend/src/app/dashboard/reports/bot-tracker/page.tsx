...
export default function BotTrackerPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/reports/bot-tracker'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Bot Tracker</h1><p><i className="fa fa-android"></i> Track and monitor bot activities across your platform</p></div></div>
