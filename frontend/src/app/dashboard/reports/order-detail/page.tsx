...
export default function OrderDetailPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/reports/order-detail'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Order Detail Report</h1><p><i className="fa fa-file-text"></i> Detailed information about all orders and transactions</p></div></div>
