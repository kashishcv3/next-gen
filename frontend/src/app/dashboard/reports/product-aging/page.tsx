...
export default function ProductAgingPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/reports/product-aging'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Product Aging Report</h1><p><i className="fa fa-clock-o"></i> Monitor product inventory age and turnover rates</p></div></div>
