...
export default function BestPracticesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/reports/site-optimization/best-practices'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Best Practices</h1><p><i className="fa fa-check-circle"></i> Review best practices recommendations and compliance status</p></div></div>
