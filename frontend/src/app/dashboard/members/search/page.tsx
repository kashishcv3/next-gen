...
export default function MemberSearchPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/members/search'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Member Search</h1><p><i className="fa fa-users"></i> Search and manage member accounts and profiles</p></div></div>
