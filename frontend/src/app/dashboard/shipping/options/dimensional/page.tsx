...
export default function DimensionalShippingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/shipping/options/dimensional', options);
      setSuccess('Dimensional Shipping saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>Dimensional Shipping</h1>
        <p><i className="fa fa-cube"></i> Configure dimensional weight shipping rates and calculations</p>
      </div></div>
