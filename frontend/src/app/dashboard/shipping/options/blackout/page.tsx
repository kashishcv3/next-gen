...
export default function BlackoutDatesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/shipping/options/blackout', options);
      setSuccess('Blackout Dates saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        ...
        <p><i className="fa fa-calendar-times-o"></i> Configure shipping blackout dates when orders cannot be shipped</p>
      </div></div>
