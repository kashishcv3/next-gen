...
export default function PresetShipDatesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/shipping/options/preset-dates', options);
      setSuccess('Preset Ship Dates saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>Preset Ship Dates</h1>
        <p><i className="fa fa-calendar"></i> Configure preset shipping dates for orders</p>
      </div></div>
