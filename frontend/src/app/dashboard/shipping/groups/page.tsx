...
export default function ShippingGroupsPage() {
  ...
  return (
    <div>
      ...
      <div className="row">
        <div className="col-lg-12">
          <Link href="/shipping/groups/add" className="btn btn-primary"><i className="fa fa-plus"></i> Add Group</Link>
        </div>
      </div>
      <br />
            ...
            <div className="panel panel-primary">
              ...
              <div className="table-responsive">
                <table className="table table-striped table-hover">
                  <thead>
                    <tr><th>Name</th><th>Description</th><th>Methods</th><th>Actions</th></tr>
                  </thead>
                  <tbody>
                    {groups.length > 0 ? groups.map(group => (
                      <tr key={group.id}>
                        ...
                        <td>{group.methods_count}</td>
                        <td>
                          <Link href={`/shipping/groups/edit/${group.id}`} className="btn btn-xs btn-info"><i className="fa fa-edit"></i></Link>
