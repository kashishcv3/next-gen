...
export default function FedExIntegrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/shipping/rate-tool/fedex', options);
      setSuccess('FedEx Integration saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>FedEx Integration</h1>
        <p><i className="fa fa-truck"></i> Configure FedEx shipping rate integration</p>
      </div></div>
