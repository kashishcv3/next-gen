...
export default function UPSIntegrationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/shipping/rate-tool/ups', options);
      setSuccess('UPS Integration saved successfully');
    } catch (err: any) {
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12">
        <h1>UPS Integration</h1>
        <p><i className="fa fa-truck"></i> Configure UPS shipping rate integration</p>
      </div></div>
