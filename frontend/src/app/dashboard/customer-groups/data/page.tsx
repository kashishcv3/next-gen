...
export default function CustomerDataPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try { const res = await api.get('/customer-groups/data'); setData(res.data.data || res.data || []); }
  ...
  return (
    <div className="container-fluid" style={{padding:'20px'}}>
      <div className="row"><div className="col-lg-12"><h1>Customer Data</h1><p><i className="fa fa-database"></i> View and analyze customer group data and metrics</p></div></div>
